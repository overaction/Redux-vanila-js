...
var btnIncrease = document.querySelector('#increase'); //#은 id값을 정의

var btnDecrease = document.querySelector('#decrease'); //1. 프로젝트의 상태에 변화를 일으키는 액션들을 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; //2. 위의 액션 이름들을 사용하여 액션 객체를 만드는 액션 생성 함수. type값을 반드시 가져야함
...
render(); // 7. 구독하기. subscribe 함수를 이용해서 상태가 업데이트 될 때마다 render가 호출되도록 만듬

store.subscribe(render); //구독취소 하려면 unsubscribe();
// 8. 액션 발생시키기(dispatch)
...
},{"redux":"../node_modules/redux/es/redux.js"}],"../../../home/gitpod/.nvm/versions/node/v10.19.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../home/gitpod/.nvm/versions/node/v10.19.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
